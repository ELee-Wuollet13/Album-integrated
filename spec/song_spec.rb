...
describe('#Song') do
  ...
  describe('.all') do
    it("returns a list of all songs") do
      song = Song.new({:name => "Naima", :album_id => 1, :id => nil})
      song.save()
      song2 = Song.new({:name => "Giant Steps", :album_id => 1, :id => nil})
      song2.save()
  ...
  #     song = Song.new({:name => "Giant Steps", :album_id => nil, :id => nil})
  #     song.save()
  #     song2 = Song.new({:name => "Naima", :album_id => nil, :id => nil})
  #     song2.save()
  #     Song.clear()
  ...
  # describe('#save') do
  #   it("saves a song") do
  #     song = Song.new({:name => "Naima", :album_id => nil, :id => nil})
  #     song.save()
  ...
  #     song = Song.new({:name => "Naima", :album_id => nil, :id => nil})
  #     song.save()
  #     song.update({:name => "Mr. P.C.", :album_id => nil})
  ...
  #     song = Song.new({:name => "Naima", :album_id => nil, :id => nil})
  #     song.save()
  #     song2 = Song.new({:name => "California", :album2_id => nil, :id => nil})
  #     song2.save()
  ...
  #     song = Song.new({:name => "Naima", :album_id => nil, :id => nil})
  #     song.save()
  #     song2 = Song.new({:name => "Cousin Mary", :album_id, :id => nil})
  #     song2.save()
